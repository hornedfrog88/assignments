...
#### Minimize (select columns) of the training_data_local and test_data_local datasets to minimized them so they only include variables of interest to the model.  The resulting training_data_minimzed dataset will then be used for some graphical exploratory analysis using the "pairs" function.
```{r }
